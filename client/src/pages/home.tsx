          ...
          <div className="flex items-center gap-8">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-sm font-black tracking-tighter text-foreground uppercase italic group-hover:text-primary transition-colors">FSDZONESJOURNAL</span>
                <span className="text-[9px] font-bold text-muted-foreground/60 uppercase tracking-[0.2em] -mt-1">FREE SMART JOURNAL</span>
              </div>
            </div>
